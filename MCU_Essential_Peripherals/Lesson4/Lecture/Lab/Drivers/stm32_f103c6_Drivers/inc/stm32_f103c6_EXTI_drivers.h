...
typedef struct
{
	...
	uint8_t Trigger_Case ;		  			//specifies EXTI pin Trigger Rising or Falling or both
								 			// This parameter must be set based on @ref EXTI_TRIGGER_DEFINE

	uint8_t IRQ_EN ;						//Enable or Disable the EXTI IRQ(will enable EXTI mask and NVIC interrupt controller)
